...
return (function () {
        ...
        /** @type {import("./tailnode-htmx").HtmxInternalApi} */
        var internalAPI = {
         ...
         * @returns {import("./tailnode-htmx").HtmxTriggerSpecification[]}
         */
         ...
         *
         * @param {HTMLElement} elt
         * @param {(extension:import("./tailnode-htmx").HtmxExtension) => void} toDo
         * @returns void
         */
         ...
         * @returns {import("./tailnode-htmx").HtmxSwapSpecification}
         */
         ...
         * @returns {import("./tailnode-htmx").HtmxSettleInfo}
         */
        ...
        /** @type {Object<string, import("./tailnode-htmx").HtmxExtension>} */
        var extensions = {};

        /**
         * extensionBase defines the default functions for all extensions.
         * @returns {import("./tailnode-htmx").HtmxExtension}
         */
         ...
         *
         * @param {string} name
         * @param {import("./tailnode-htmx").HtmxExtension} extension
         */
         ...
         *
         * @param {HTMLElement} elt
         * @param {import("./tailnode-htmx").HtmxExtension[]=} extensionsToReturn
         * @param {import("./tailnode-htmx").HtmxExtension[]=} extensionsToIgnore
         */
